...
namespace Gavin.Util
{
    public class ConvertHelper
    {
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        public static int? ToIntOrNull(object o)
        {
            if (o == null)
                return null;
            int result;
            bool isValid = int.TryParse(o.ToString(), out result);
            if (isValid)
                return result;
            return null;
        }
        ...
        public static double ToDouble(object o)
        {
            if (o == null)
                return 0;
            double result;
            return double.TryParse(o.ToString(), out result) ? result : 0;
        }

        /// <summary>
        /// 转换为双精度浮点数并按指定小数位4舍5入
        /// </summary>
        /// <param name="o"></param>
        /// <param name="d">小数位数</param>
        /// <returns></returns>
        public static double ToDouble(object o, int d)
        {
            return Math.Round(ToDouble(o), d);
        }
